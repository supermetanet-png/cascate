...
app.get('/api/data/:slug/tables/:table/sql', resolveProject as any, cascataAuth as any, async (req: any, res: any) => {
  // Gera o DDL da tabela para exportação
...
app.post('/api/data/:slug/rpc/:name', resolveProject as any, cascataAuth as any, async (req: any, res: any) => {
...
app.listen(PORT, () => console.log(`[CASCATA MASTER ENGINE] v2.7 Operacional na porta ${PORT}`));
